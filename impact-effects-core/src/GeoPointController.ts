...
class GeoPointController
{
    ...
    observation_point: Point)
    {
        ...
        this.entry_point_geo.changed.on((_s: any, p: string[]) => this.intersection_point_geo_recalc(p));
        this.entry_point.changed.on((_s: any, p: string[]) => this.intersection_point_geo_recalc(p));

        this.entry_point_recalc();
        this.intersection_point_geo.changed.on((_s: any) => this.observation_point_geo_recalc());
        this.observation_point.changed.on((_s: any) => this.observation_point_geo_recalc());

        this.observation_point_geo.changed.on((_s: any, p: string[]) => this.observation_point_recalc(p));
