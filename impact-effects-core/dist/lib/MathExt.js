...
class MathExt {
    ...
    static round_by_digits_to_string(real, n) {
        if (real == 0)
            return "0";
        if (n == 0) {
    ...
    static dimension_prefix_format(real, dimension_formatter, n) {
        if (real == 0) {
            return "0 ";
        }
    ...
    static seconds_to_string(s, show_ms = false) {
        let local = s;
